...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../CodeCracker.sopcinfo
...
# Design Name 
# setting SOPC_NAME is CodeCracker
SOPC_NAME := CodeCracker
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x210b0
SOPC_SYSID_FLAG += --sidp=0x210b0
ELF_PATCH_FLAG  += --sidp 0x210b0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1645564794
SOPC_SYSID_FLAG += --timestamp=1645564794
ELF_PATCH_FLAG  += --timestamp 1645564794
