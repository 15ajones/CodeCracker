...
module CodeCracker_mm_interconnect_0_router_default_decode
  #(
...
module CodeCracker_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    CodeCracker_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x210a0 .. 0x210b0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 18'h210a0  && read_transaction  ) begin
