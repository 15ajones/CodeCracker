...
module codebreaker_mm_interconnect_0_router_default_decode
  #(
...
module codebreaker_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    codebreaker_mm_interconnect_0_router_default_decode the_default_decode(
